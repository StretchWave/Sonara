...
,"en" : {
    ...
    "basedOnLikes": "Based on your likes",
    ...
    "galaxyOverlay": "Galaxy star overlay",
    "galaxyOverlayDes": "Animated interactive starfield over the player background",
    "playbackSpeed": "Playback speed",
    "listeningStatistics": "Listening statistics",
    "viewStatistics": "View statistics",
    "viewStatisticsDes": "Play counts, listening time and your yearly Wrapped recap",
    "allTime": "All time",
    ...
    "clearStatisticsDes": "This will permanently delete all recorded listening statistics",
    "clear": "Clear",
    "noStatisticsData": "No listening data recorded yet. Play some music first!",
    "myMusicRecap": "My Music Recap",
    "songsPlayedCount": "songs played",
    "listened": "listened",
    "lastfmScrobbling": "Last.fm scrobbling",
    "lastfmScrobblingDes": "Scrobble tracks and update Now Playing on your Last.fm profile",
    "lastfmAccount": "Last.fm account",
    "lastfmConfigure": "Configure",
    "lastfmDisconnect": "Disconnect",
    "lastfmConnected": "Connected",
    "lastfmNotConnected": "Not connected",
    "lastfmApiKey": "API key",
    "lastfmApiSecret": "Shared secret",
    "lastfmConnect": "Connect with Last.fm",
    "lastfmAuthorizedDone": "I've authorized — finish",
    "lastfmAuthInstruction": "Authorize the app in the opened browser page, then come back and tap the finish button",
    "lastfmCredentialsDes": "Create a free API application at last.fm/api/account/create and enter its key and shared secret",
    "lastfmMissingCredentials": "Please enter your API key and shared secret first",
    "lastfmAuthFailed": "Last.fm authorization failed. Please try again",
    "lastfmNetworkError": "Could not reach Last.fm. Check your connection",
    "lastfmNoPendingAuth": "No pending authorization. Start the connect flow again",
    ...
    "more": "More",
    "noPlays": "No plays",
    "lyricsResync": "Lyrics resync",
    "lyricsResyncDes": "Fine-tune lyric timing for this song",
    "tapToSeek": "Tap to seek",
    "pureBlack": "Pure black (OLED)",
    "densityScale": "UI density",
    "densityScaleDes": "Scale the interface size (text and spacing)",
    "native100": "Native (100%)",
    "compact85": "Slightly compact (85%)",
    "compact75": "Compact (75%)",
    "compact65": "Very compact (65%)",
    "compact55": "Ultra compact (55%)",
    "importSpotifyPlaylist": "Import Spotify Playlist",
    "importSpotifyPlaylistDes": "Import a Spotify playlist and match every track against YouTube Music, fetch synced lyrics, and add the matched tracks to your library.",
    "spotifyImportDes": "Import a Spotify playlist and match its tracks",
    "spotifyImportDesSub": "Resolve Spotify tracks against YouTube Music, review matches, and add them to your library",
    "migratingTracks": "Migrating tracks…",
    "spotifyPlaylistUrlLabel": "Playlist URL or ID",
    "spotifyAutoFetchLyrics": "Automatically fetch lyrics",
    "spotifyAutoFetchLyricsDes": "Fetch synced lyrics from LRCLIB after a Spotify import",
    "spotifyAutoEnrichTracks": "Enrich with MusicBrainz",
    "spotifyAutoEnrichTracksDes": "Look up ISRCs on MusicBrainz for tracks that lack one (improves matching)",
    "authRequiredTitle": "Couldn't retrieve this playlist automatically",
    "authRequiredDes": "The playlist was identified, but no automatic source could load its tracks. Try again or use another playlist.",
    "tryAgain": "Try again",
    "tryAnotherPlaylist": "Try another playlist",
    "resolvingPlaylist": "Resolving playlist tracks…",
    "sourcesTitle": "Metadata sources",
    "sourcePublic": "Public metadata",
    "sourceCached": "Cached mappings",
    "sourceBackend": "Sonara backend",
    "sourceMusicBrainz": "MusicBrainz",
    "sourceAvailable": "available",
    "sourceReady": "ready",
    "sourceNotConfigured": "not configured",
    "enrichingTracks": "Enriching track identities…",
    "reimportTitle": "This playlist was imported before",
    "reimportIncomplete": "An incomplete import was found",
    "reimportLastImported": "Last imported",
    "reimportPreviouslyResolved": "Previously resolved",
    "reimportResumeHint": "— you can resume where it stopped",
    "reimportUnchanged": "unchanged",
    "reimportChanged": "changed",
    "reimportNew": "new",
    "reusePreviousMatches": "Reuse previous matches",
    "reResolveEverything": "Re-resolve everything",
    "startFresh": "Start fresh (discard previous import)",
    "matchingTracks": "Matching tracks",
    "fetchingLyrics": "Fetching synced lyrics…",
    "cancelImport": "Cancel",
    "importCancelled": "Import paused — everything resolved so far is saved",
    "filterNeedsReview": "Needs review",
    "filterMatched": "Matched",
    "filterUnavailable": "Unavailable",
    "filterEmpty": "No tracks in this filter",
    "searchAgain": "Search again",
    "skipTrack": "Skip track",
    "createPlaylist": "Create playlist",
    "confidenceHigh": "High confidence",
    "confidenceHighMedium": "High + medium",
    "confidenceAllMatches": "All matches",
    "eligibleTracks": "tracks selected",
    "lyricsSummary": "Lyrics",
    "lyricsSynced": "synced",
    "lyricsPlain": "plain",
    "lyricsInstrumental": "instrumental",
    "lyricsUnavailable": "unavailable",
    "lyricsFailed": "failed",
    "all": "All",
    "matched": "matched",
    "uncertain": "uncertain",
    ...
    "retryUnmatched": "Retry unmatched",
    "continue": "Continue",
    "unavailableTrack": "Unavailable track",
    "chooseMatch": "Choose match",
    "noCandidates": "No candidates found",
    "migrationDestination": "Migration destination",
    "addToLikedSongs": "Add to Liked Songs",
    "addToLikedSongsDes": "Add the matched tracks to your favorites",
    "createNewPlaylist": "Create new playlist",
    "createNewPlaylistDes": "Create a local playlist with the matched tracks",
    "addToExistingPlaylist": "Add to existing playlist",
    "addToExistingPlaylistDes": "Append the matched tracks to a playlist you already have",
    "noUserPlaylists": "No playlists available — create one first",
    "migrationComplete": "Migration complete",
    "added": "Added",
    "alreadyExists": "Already exists",
    "failed": "Failed",
    "importAnother": "Import another",
    "migrationSaved": "Migration saved",
    "done": "Done",
    "save": "Save"
},"eo" : {
...
,"pl" : {
    ...
    "basedOnLikes": "Na podstawie polubionych",
    "trending": "Trendy",
